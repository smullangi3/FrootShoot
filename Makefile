...
OFILES = gba.o font.o main.o images/garbage.o images/startBackground.o images/playBackground.o images/shotMarkImage.o images/fruitImage.o images/fruitSplatImage.o
